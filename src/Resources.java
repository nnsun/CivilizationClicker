...
{	
	...
	//constructor for all resources, land stats, buildings, and military strength
	public Resources()
	{
		gold = 0;
		food = 0;
	...
	//Tier 4 buildings are 125 times more effective than T1 buildings, T3 builings are 30 times more effective, and T2 buildings are 5 times more effective
	...
	//setter methods that allow for adding resources, losing resources, military strength, land values, and adding buildings
	public void setGold()
	{
		gold++;
	}
